module Displayable
  ...
  def display_welcome
    output("Hello, and welcome to Rock, Paper, Scissors!")
    puts
  end
  ...
  def display_grand_winner(human, computer, score)
    if score.human > score.computer
      ...
      output("Programmers like you are responsible "\
       "for the triumph of machines over humankind. Congratulations.")
       puts
    end
  end
...
class Human < Player
  ...
  def choose
    choice = nil
    loop do
      output("Please  type 'rock', 'paper', or 'scissors':")
...
# Message module as an alternative to YAML that allows for string interpolation?
